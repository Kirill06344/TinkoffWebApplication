...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, LocalDateTime> CHECKED_AT =
        createField(DSL.name("CHECKED_AT"), SQLDataType.LOCALDATETIME(6), this, "");
    ...
    /**
     * The column <code>LINK.INTR_COUNT</code>.
     */
    public final TableField<LinkRecord, Long> INTR_COUNT =
        createField(DSL.name("INTR_COUNT"), SQLDataType.BIGINT, this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function5<? super Long, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super Long, ? extends U> from
    ) {
