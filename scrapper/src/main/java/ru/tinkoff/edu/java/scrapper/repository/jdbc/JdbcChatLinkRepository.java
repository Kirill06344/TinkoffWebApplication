...
public class JdbcChatLinkRepository implements ChatLinkRepository {
    ...
    private static final String SQL_DELETE_CHAT_LINK_BY_CHAT_LINK =
    ...
    public Optional<ChatLink> add(ChatLink entity) {
        ...
        try {
            var res =
                jdbcTemplate.queryForObject(SQL_ADD_CHAT_LINK, chatLinkMapper, entity.getChatId(), entity.getLinkId());
